      ...
      <main className="bg-white mt-3">
        ...
        >
          <div className="w-[95%]  h-fit bg-white/75">
            <div className="text-left p-14 m-auto  xms:p-2">
              <h2 className="text-logo font-bold font-Crim text-3xl pb-4 xms:text-2xl">
                Environmental Impact
              </h2>
              <p className=" text-black font-Crim text-2xl w-[95%] font-medium xms:text-lg">
